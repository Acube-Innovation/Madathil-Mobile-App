...
class UserSearchableDropdown extends StatefulWidget {
...
class _SearchableDropdownState extends State<UserSearchableDropdown> {
  ...
  void _fetchCustomers({String? searchItem}) {
    ...
    customerViewModel.getListUsers(searchItem: searchItem);
  }
